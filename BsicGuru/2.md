...
Separaating code from site-specific configuration
...
You need to try to maintain a certain obstruction level in code
and to keep out very specific information
...
Separationg sire-specific information from static code is also referred to as decoupling
...
When value is starting with the variable or the entire value is hust the variable. The entire value must be between double quotes.
